...
void Breakout::Init()
{
    ...
    auto backgroundRenderer = Background->AddRenderer<SpriteRenderer, Texture2D*>(
    ...
    auto playerRenderer = Player->AddRenderer<SpriteRenderer, Texture2D*>(
    ...
    auto ballRenderer = Ball->AddRenderer<SpriteRenderer, Texture2D*>(
